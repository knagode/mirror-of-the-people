parties = [
  {
    ...
    program: <<~PROGRAM
      ...
      - Sodobno izobrazevanje: posodobitev solskega sistema, vec digitalnih kompetenc
      - Zdravstvena reforma: krajsanje cakalnih dob, krepitev javnega zdravstva
      - Gospodarska rast: podpora startupom in inovacijam, razbremenitvev malih podjetij
      - Pravna drzava: neodvisnost sodstva, boj proti korupciji
      - Stanovanjska politika: gradnja javnih najemniskih stanovanj
      - Kultura in mediji: neodvisnost javnih medijev, podpora kulturi
    PROGRAM
  },
  {
    ...
    program: <<~PROGRAM
      ...
      - Tradicionalne vrednote: podpora druzini, demografski ukrepi za visjo rodnost
      - Gospodarski razvoj: privabljanje tujih investicij, nizji prispevki za delodajalce
      - Obramba: povecanje obrambnega proracuna na 2% BDP, podpora NATO
      - Infrastruktura: gradnja avtocest, hitri internet po vsej Sloveniji
      - Energetska neodvisnost: JEK2 (druga enota nuklearke), diverzifikacija virov
      - Nasprotovanje pretiranim regulacijam EU
    PROGRAM
  },
  {
  ...
  },
  {
    ...
    program: <<~PROGRAM
      ...
      - Javno zdravstvo: popolnoma javno zdravstvo brez zasebne konkurence, vec denarja za zdravstvo
      - Pokojnine: visje pokojnine, pravicnejsi pokojninski sistem
      - Stanovanja: regulacija najemnin, gradnja socialnih stanovanj
      - Okolje: zeleni prehod z upostevanjem socialnih posledic, pravicen prehod
      - Izobrazevanje: brezplacno solstvo na vseh ravneh, vec stipendij
      - Enakost: pravice LGBTQ+, enakost spolov
    PROGRAM
  },
  {
    name: "Levica",
  ...
  },
  {
    ...
    program: <<~PROGRAM
      ...
      - Varnost: vec policistov, ostrejse kazni za kriminalce
      - Gospodarstvo: podpora domacim podjetjem, zascita pred tujim kapitalom
      - Energetika: energetska samozadostnost, JEK2
      - Kritika EU: nasprotovanje prenosu pristojnosti na Bruselj
      - Kulturna dediscina: varovanje slovenske kulture in jezika
      - Obramba: mocna vojska, obvezni vojaski rok
    PROGRAM
  },
  {
  ...
  },
  {
    ...
    program: <<~PROGRAM
      ...
      - Zdravstvo: svobodna izbira zdravljenja, kritika obveznega cepljenja
      - Suverenost: zascita slovenske suverenosti pred globalnimi organizacijami
      - Pravicnost: boj proti korupciji, odprava privilegijev politikov
      - Gospodarstvo: podpora domacemu gospodarstvu, nizji davki
      - Svoboda govora: zascita svobode izrazanja, proti cenzuri
      - Energetika: energetska neodvisnost Slovenije
    PROGRAM
  },
  {
    name: "Nasi",
